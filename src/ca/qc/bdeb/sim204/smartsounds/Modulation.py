...
class Modulation:
    ...
    def trouver_pivot(self):  # méthode privée
        ...
        if self.tonalite_principale.isupper():  # majeure
            ...
            self.tonalite_apparentee = Intervals.major_sixth(str.upper(self.tonalite_principale))
    ...
    def modulation_en_cours(self):
        ...
        self.progression = ProgressionAccords.ProgressionAccords(self.tonalite_apparentee, self.nombre_mesure,
                                                                 self.pivot)
